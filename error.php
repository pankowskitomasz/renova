...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid privacy-s1 border-bottom border-red">
            <div class="row p-20 text-center h-100vh  d-flex">
                <div class="col-xs-12 col-xs-offset-0 col-sm-6 col-sm-offset-3 p-40 mx-auto my-auto">
